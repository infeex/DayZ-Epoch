...
crash_spawner = compile preprocessFileLineNumbers "\z\addons\dayz_server\modules\crash_spawner.sqf";
supply_drop = compile preprocessFileLineNumbers "\z\addons\dayz_server\modules\supply_drop.sqf";
